...
import com.codflix.backend.utils.PasswordHash;

import java.sql.*;

public class UserDao {

    // return true or false if an account with the mail passed in parameters already exist
    ...
    public User getUserByCredentials(String email, String password) {
        ...
        try {
            ...
            st.setString(1, email);
            st.setString(2, PasswordHash.hashPassword(password));
    ...
    public boolean createUserByCredentials(String email, String password) {
        ...
        try {
            String requete = "INSERT INTO user (email, password) VALUES ('" + email + "', '" + PasswordHash.hashPassword(password) + "')";
